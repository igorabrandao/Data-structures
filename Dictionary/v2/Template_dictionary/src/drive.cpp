...
int main()
{
    ...
    DictionaryAL<int, string, SortedByInt> d;
    //===================================[ Testando push() ]===================================//
    cout << "\n===================================================================" << endl;
    ...
    cout << "A menor chave da lista eh a chave: " << d.min(sortedByInt) << endl;
    cout << "A maior chave da lista eh a chave: " << d.max(sortedByInt) << endl;
    cout << "\n>>> Metodo min() OK!!!" << endl;
    ...
    //******************************************************************************************/
    //=================================[Testando a lista sorted]=================================//
    DictionarySAL<int, string, SortedByInt> ds;
