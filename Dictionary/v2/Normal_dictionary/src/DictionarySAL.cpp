...
/* Busca binaria pelo elemento do vetor */
int
DictionarySAL::_search(Key _x) const
{
...
bool
DictionarySAL::pop( Key _x , Data & _s )
{
	bool bResult;
...
bool
DictionarySAL::search( Key _x, Data & _s ) const
{
	int left = 0;
...
bool
DictionarySAL::push( Key _newKey, Data _newInfo )
{
...
bool
DictionarySAL::successor(Key _x, Key& _y ) const
{
    bool bResult;
    int aux = _search(_x);
...
bool
DictionarySAL::predecessor(Key _x, Key & _y) const
{
    bool bResult;
    int aux = _search(_x);
    /* se ele existir na lista e tiver sucessor */
